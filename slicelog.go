...
// for the API server, but it leaves no sign in the log.
...
// on every tenth pass says nothing fixed about how old the newest
// line may be. Ten minutes against a 60 second backstop is one
